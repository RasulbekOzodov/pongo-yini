...
// Player Names
const player1Name = "Birinchi o'yinchi";
const player2Name = "Ikkinchi o'yinchi";

// Control Key Names
const player1Controls = "W (Tepaga) / S (Pastga)";
const player2Controls = "Tepa Chiziq (Tepaga) / Past Chiziq (Pastga)";
...
function drawInfo() {
  ...
  ctx.font = "20px Arial";
  ctx.textAlign = "left";
  ctx.fillText(`${player1Controls}`, 20, 70);
  ctx.textAlign = "right";
  ctx.fillText(`${player2Controls}`, canvas.width - 20, 70);
}
